...
const categories: Category[] = [
  ...
  },
  {
    ...
    description: "Hình ảnh món ăn siêu thực, mâm đồ ăn hoành tráng gây ấn tượng mạnh.",
    icon: <Utensils className="w-6 h-6" />,
    link: "https://mukbanghaisan.vercel.app/",
    isFeatured: true,
  },
  {
    title: "XÂY KÊNH THỜI TRANG",
    description: "AI Thời trang affilate tối ưu nhất",
    icon: <Flame className="w-6 h-6" />,
    link: "https://thoitrang-woad.vercel.app/",
  },
  {
    title: "XÂY KÊNH HÀI HƯỚC",
    description: "Tạo ra những kịch bản video hài hước xây kênh",
    icon: <Utensils className="w-6 h-6" />,
    link: "https://haihuoc-seven.vercel.app/",
  },
  {
    title: "TIMELAP",
